...
datasets = rawDatasetsLoader.loadDatesets(trainDataSize = 60000, testDataSize = 10000, dataType=dataType)
...
# with open('/home/amax/lym/WKAFL-code-main/fashionmnist/fashionmnist_WKAFL_testacc_1.txt', 'a+') as fl:
...
#
# with open('/home/amax/lym/WKAFL-code-main/fashionmnist/fashionmnist_WKAFL_testloss_1.txt', 'a+') as fl:
#     fl.write('\n' + date + ' Results (UN is {}, K is {}, threshold is {}, CB1 is {}, CB2 is {}, BZ is {}, LR is {}, '.
#              format(args.user_num, args.K, args.threshold, args.CB1, args.CB2, args.batch_size, args.lr))
#     fl.write('total itr is {}, itr_test is {}, stageTwo is {}, classNum is {})\n'.
#              format(args.total_iterations, args.itr_test, args.stageTwo, args.classNum))
...
#
# with open('/home/amax/lym/WKAFL-code-main/fashionmnist/fashionmnist_WKAFL_trainloss_1.txt', 'a+') as fl:
#     fl.write('\n' + date + ' Results (UN is {}, K is {}, threshold is {}, CB1 is {}, CB2 is {}, BZ is {}, LR is {}, '.
#              format(args.user_num, args.K, args.threshold, args.CB1, args.CB2, args.batch_size, args.lr))
#     fl.write('total i tr is {}, itr_test is {}, stageTwo is {}, classNum is {})\n'.
#              format(args.total_iterations, args.itr_test, args.stageTwo, args.classNum))
#     fl.write('trainloss: ' + str(logs['train_loss']))
with open('/home/amax/lpy/fashionmnist/fashionmnist_WKAFL_testacc_1.txt', 'a+') as fl:
...
with open('/home/amax/lpy/fashionmnist/fashionmnist_WKAFL_testloss_1.txt', 'a+') as fl:
    fl.write('\n' + date + ' %Results (user_num is {}, K is {}, CB is {}, B is {}, sim_threshold is {},'.
             format(args.user_num, args.K, args.CB1, args.CB2, args.threshold))
...
with open('/home/amax/lpy/fashionmnist/fashionmnist_WKAFL_trainloss_1.txt', 'a+') as fl:
    fl.write('\n' + date + ' %Results (user_num is {}, K is {}, CB is {}, B is {}, sim_threshold is {},'.
             format(args.user_num, args.K, args.CB1, args.CB2, args.threshold))
    fl.write(' BZ is {}, LR is {}, itr_test is {}, total itr is {})\n'.
             format( args.batch_size, args.lr, args.itr_test, args.total_iterations))
